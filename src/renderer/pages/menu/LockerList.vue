<template>
    <div>
        <div class="buttons">
            ...
            <button
                @click="multipleOpen = !multipleOpen; selectedLockers = []"
            >Select multiple Locker</button>
            <button
                class="buttons--open-multiple"
                @click="openMultipleBox"
                v-if="multipleOpen"
            >Open Multiple Locker</button>
        </div>
        <ul>
            <li
                :class="['locker', {'locker-unavailable': locker.status === 'Unavailable'}, {'locker-available': locker.status === 'Available'}]"
